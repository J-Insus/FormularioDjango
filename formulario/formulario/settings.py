...
BASE_DIR = Path(__file__).ancestor(3) #Modificamos el BASE_DIR con antecesor
...
INSTALLED_APPS = [
    ...
    'applications.home', # llamamos a nuestra aplicacion de esta manera
]
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
            'DIRS': [BASE_DIR.child('templates')],#indicar de donde sale los templates
            'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
